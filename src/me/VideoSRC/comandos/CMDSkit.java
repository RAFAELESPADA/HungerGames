...
/*    */     {
	if (!p.hasPermission("tag.mod")){
  	  sender.sendMessage("§c§lERROR §fYou dont have permission");
  	  return true;
    }
/* 42 */       if (args.length == 0) {
/* 43 */         p.sendMessage("§6§lS§f§lKIT" + "" + "§7> §cUse /skit create|apply [name]|[range]");
/* 44 */         return true;
/*    */       }
/* 46 */       if (args[0].equalsIgnoreCase("create")) {
/* 47 */         if (args.length == 1) {
/* 48 */           p.sendMessage("§6§lHG" + "" + "§7> §cUtilize: /skit create [Kit Name]");
/* 49 */           return true;
/*    */         }
...
/* 54 */         p.sendMessage("§6§lHG" + "" + "§7> §aKit " + args[1] + " §a created!");
/* 55 */         return true;
/*    */       }
/* 57 */       if (args[0].equalsIgnoreCase("apply")) {
/* 58 */         if (args.length <= 2) {
/* 59 */           p.sendMessage("§6§lHG" + "" + "§7> §cUso correto: /skit apply [kit] [range]");
/* 60 */           return true;
/*    */         }
/* 62 */         String name = args[1];
/* 63 */         if ((!this.kit.containsKey(name)) && (!this.armadura.containsKey(name))) {
/* 64 */           p.sendMessage("§6§lHG" + "" + "§7> §cThis kit " + name + " dont exists!");
/* 65 */           return true;
/*    */         }
/* 67 */         if (isInt(args[2])) {
...
/*    */             }
/*    */           }
/* 77 */           p.sendMessage("§6§lHG" + "" + "§7> §aKit " + name + " get applied to all players in the range of " + numero + " blocks");
/* 78 */           return true;
/*    */         }
/*    */       }
/*    */     }
