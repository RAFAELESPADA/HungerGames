...
public class FeastManager {
	...
	public static void announceFeast(Integer time) {
		...
		Bukkit.broadcastMessage("§cFEAST§7, The feast will spawn in: §f" + df.format(mainBlock.getLocation().getX())
				+ "§§7,§§f " + df.format(mainBlock.getLocation().getY()) + "§§7,§§f "
				+ df.format(mainBlock.getLocation().getZ()) + "§§7 em §§f" + time + " §§7minute" + s
				+ "§§7 Use §§f/Feast");
	...
	public static void spawnFeast() {
		...
		DecimalFormat df = new DecimalFormat("##.#");
		Bukkit.broadcastMessage("§cFEAST§7, O Feast nasceu em: §f" + df.format(mainBlock.getLocation().getX())
				+ "§§7, §§f" + df.format(mainBlock.getLocation().getY()) + "§§7, §§f"
				+ df.format(mainBlock.getLocation().getZ()) + " §§7[§§a§§lBOA SORTE§§7]");
